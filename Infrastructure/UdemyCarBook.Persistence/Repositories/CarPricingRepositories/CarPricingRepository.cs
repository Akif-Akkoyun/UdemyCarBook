...
namespace UdemyCarBook.Persistence.Repositories.CarPricingRepositories
{
    public class CarPricingRepository : ICarPricingRepository
    {
        ...
        public List<CarPricingEntity> GetCarPricingWithTimePeriod()
        {
        ...
        public List<CarPricingViewModel> GetCarPricingWithTimePeriod1()
        {
            ...
            {
                command.CommandText = "Select * From (Select Model,Name,CoverImageUrl,PricingID,Amount From CarPricings Inner Join Cars On Cars.Id=CarPricings.CarId Inner Join Brands On Brands.Id=Cars.BrandID) As SourceTable Pivot (Sum(Amount) For PricingID In ([3],[4],[6])) as PivotTable;";
